...
let Apple = document.querySelector('#kompania tbody')

for (let i = 0; i < produktet.products.length; i++) {
    let telefon = produktet.products[i]

    let kokakolla = Apple.insertRow()

    kokakolla.insertCell(0).innerHTML = telefon.title;
    kokakolla.insertCell(1).innerHTML = telefon.description;
    kokakolla.insertCell(2).innerHTML = telefon.price;
    kokakolla.insertCell(3).innerHTML = telefon.rating;
    kokakolla.insertCell(4).innerHTML = telefon.brand;
    kokakolla.insertCell(5).innerHTML = telefon.category;
    kokakolla.insertCell(6).innerHTML = `<img src="${telefon.thumbnail}"/>`;
